import { createClient } from "https://esm.sh/@supabase/supabase-js@2.100.1";
  ...
  Deno.serve(async (req) => {
    ...
    try {
      ...
      const {
        amount, email, product_id, product_name, product_price,
        payment_type, deposit_amount, interest_rate, total_payable,
        remaining_balance, installment_months, callback_url,
      } = body;
